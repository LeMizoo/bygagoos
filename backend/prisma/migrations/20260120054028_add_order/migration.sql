...
INSERT INTO "new_Order" ("clientId", "createdAt", "id", "notes", "orderNumber", "status", "totalAmount", "updatedAt") SELECT "clientId", "createdAt", "id", "notes", "orderNumber", "status", "totalAmount", "updatedAt" FROM "Order";
DROP TABLE "Order";
